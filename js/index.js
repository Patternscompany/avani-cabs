parcelRequire = (function (e, r, t, n) {
...
})(
  {
    ...
    A2T1: [
      function (require, module, exports) {
        ...
        function c(e, t) {
          ...
          switch (e) {
            case "wa":
              return "https://wa.me/" + t + "/?text=" + c;
            case "viber":
              return "viber://pa?chatURI=" + t + "?text=" + c;
            case "tg":
              return "https://t.me/" + t;
            case "line":
              return "https://line.me/R/ti/p/" + t;
            default:
              return "";
          }
        }
        function l() {
          switch (
            ...
            case "none":
              return "none";
            case "low":
              return "rgba(99, 99, 99, 0.2) 0px 2px 4px";
            case "medium":
              return "rgba(0, 0, 0, 0.24) 0px 4px 8px";
            case "high":
        ...
        const n = (t) => {
          ...
          return e.default.createElement(
            "div",
            {
              onClick: () => window.open(c(u, d, p), "_blank"),
              style: {
                background: n,
                boxSizing: "border-box",
                display: "inline-flex",
                padding: r ? "10px 14px" : "12px",
                justifyContent: "center",
                alignItems: "center",
                color: "light" === a ? "#fff" : "#000",
                cursor: "pointer",
                borderRadius: i,
                position: "fixed",
                boxShadow: l(s),
                right: "right" === f ? h : "auto",
                left: "left" === f ? h : "auto",
                bottom: o,
                zIndex: C,
              },
    ...
    Focm: [
      ...
      { react: "n8MK", "react-dom": "NKHc", "./app": "A2T1" },
    ],
  },
  {},
  ["Focm"],
